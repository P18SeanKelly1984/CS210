	...
	public static int decimal(int numerator, int divisor, int n)
		{
			if(n == 0)
			{
				//Will return how many times the divisor goes in to the numerator
				return(numerator - (numerator % divisor)) / divisor; 
			}

			//Will make the numerator smaller each time
			return(decimal((numerator % divisor)*10, divisor, n-1)); 
		}

	//An alternative, non-recursive way to answer the question
	public static int decimal2(int numerator, int divisor, int n)
		{ //eg. 1000, 13, 2
